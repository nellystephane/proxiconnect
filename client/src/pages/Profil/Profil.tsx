  ...
  return (
    <div className="max-w-2xl mx-auto pb-24 animate-fade-in space-y-6">
      ...
      {onglet === 'annonces' && (
        <div className="space-y-3 animate-fade-in">
          ...
          {loadingAnnonces ? (
            ...
            mesAnnonces.map((a) => (
              <div key={a._id} className="flex items-center gap-3 p-3 rounded-xl bg-white border border-slate-200">
      ...
      {onglet === 'avis' && (
        <div className="space-y-3 animate-fade-in">
          {statsAvis.total > 0 && (
            <div className="flex items-center gap-2 p-4 rounded-xl bg-white border border-slate-200">
      ...
      {onglet === 'parametres' && (
        <div className="space-y-6 animate-fade-in">
          {/* Édition profil */}
          <form onSubmit={handleSaveProfil} className="p-5 rounded-2xl bg-white border border-slate-200 space-y-4">
          ...
          {/* Mot de passe */}
          <form onSubmit={handleChangePwd} className="p-5 rounded-2xl bg-white border border-slate-200 space-y-4">
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide flex items-center gap-2">
              ...
              <div className="p-4 rounded-xl bg-red-50 border border-red-200 space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-lg bg-white border border-slate-200 text-sm font-medium text-slate-600 hover:bg-slate-50 transition"
                  >
