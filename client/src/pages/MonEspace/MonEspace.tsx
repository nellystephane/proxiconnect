...
const ESPACES: EspaceInfo[] = [
  { id: 'vente', nom: 'Espace Vendeur', description: 'Créez une boutique et vendez vos produits.', icon: Store, couleur: '#007AFF', route: '/vente' },
  { id: 'restauration', nom: 'Espace Restauration', description: 'Présentez votre carte et recevez des commandes.', icon: UtensilsCrossed, couleur: '#f59e0b', route: '/restauration' },
  { id: 'hotel', nom: 'Espace Hôtel', description: 'Présentez vos chambres et recevez des réservations.', icon: Building2, couleur: '#a855f7', route: '/hotel' },
  { id: 'livraison', nom: 'Espace Livreur', description: 'Recevez des demandes de livraison près de chez vous.', icon: Bike, couleur: '#22c55e', route: '/livraison' },
];

const MonEspace = () => {
  const { espacesActifs, chargement } = usePlatform();
