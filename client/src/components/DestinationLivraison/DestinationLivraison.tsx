    ...
    <div className="space-y-3">
      ...
      <div>
        <p className="text-xs font-semibold text-slate-600 mb-1.5 flex items-center gap-1.5">
          <MapPin className="w-3.5 h-3.5 text-[#007AFF]" /> Localisation sur la carte
          <span className="font-normal text-slate-400 normal-case">— Facultatif</span>
        </p>
        {positionAjoutee ? (
          <div className="flex items-center justify-between gap-2 px-3.5 py-2.5 rounded-xl bg-emerald-50 border border-emerald-100">
            <span className="flex items-center gap-1.5 text-xs font-medium text-emerald-700">
              <Check className="w-3.5 h-3.5" /> Position ajoutée
            </span>
            <button type="button" onClick={retirerPosition} className="text-emerald-600 hover:text-emerald-800 p-1" aria-label="Retirer la position">
          ...
          <button
            ...
            disabled={recherche}
            className="w-full flex items-center justify-center gap-2 px-3.5 py-2.5 rounded-xl glass-light text-sm font-medium text-slate-600 hover:bg-blue-50/60 hover:text-[#007AFF] transition-all duration-200 disabled:opacity-60"
          >
