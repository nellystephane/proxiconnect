      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full py-3 bg-slate-100/70 dark:bg-white/[0.06] border rounded-xl text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 outline-none transition-all duration-200 focus:bg-white dark:focus:bg-white/[0.1] focus:ring-2 ${
              error
