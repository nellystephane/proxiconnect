      ...
      <div className="w-full">
        ...
        <div className="relative">
          <select
            ...
            id={inputId}
            aria-invalid={!!error}
            className={`w-full appearance-none pl-4 pr-10 py-3 bg-slate-100/70 border rounded-xl text-sm text-slate-900 outline-none transition-all duration-200 focus:bg-white focus:ring-2 ${
