    ...
    return (
      <div className="w-full">
        ...
        <textarea
          ...
          className={`w-full px-4 py-3 bg-slate-100/70 border rounded-xl text-sm text-slate-900 placeholder-slate-400 outline-none resize-none transition-all duration-200 focus:bg-white focus:ring-2 ${
            error
